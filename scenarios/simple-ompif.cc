...
int main(int argc, char* argv[])
{
  ...
  ndnHelper.Install (routers);
	...
	ParameterConfiguration::getInstance()->setParameter("PREFIX_COMPONENT", 0); // set prefix component

  //install OMPIF on routers
  //ns3::ndn::StrategyChoiceHelper::Install<nfd::fw::OMPIFRouter>(Names::Find<Node>("Router3"),"/");
	ns3::ndn::StrategyChoiceHelper::Install<nfd::fw::OMPIFRouter>(routers,"/");

	//install OMPIF on clients
  ns3::ndn::StrategyChoiceHelper::Install<nfd::fw::OMPIFClient>(streamer0,"/");
  ns3::ndn::StrategyChoiceHelper::Install<nfd::fw::OMPIFClient>(streamer1,"/");
